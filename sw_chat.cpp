...
int main(int argc, char *argv[]) {
    ...
    if (G.sys_prompt.empty()) {
        G.sys_prompt =
            "Работаешь с системой через bash-блоки (не tool-call), ведёшь память в файлах. Работай бережно.\n"
            "\n"
            ...
            "- После вывода блока bash больше ничего не пиши, когда получишь его результат, продолжай работу с учетом результатов выполнения.\n"
